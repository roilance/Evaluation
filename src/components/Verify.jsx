...
function Verify(){
    ...
    return(
        <div className='container'>
            ...
            <input onChange={firstInput} placeholder='First Name'/><br></br>
            <button onClick={(firstName=== 'Liana' || firstName === 'Liana Rose') ? verified : notVerified}>Submit</button>         
            </form>  

            {content ? navigate('/table') : notVerified}
